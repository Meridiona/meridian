...
tell application "Terminal"
    ...
    do script "echo '=== MLX server (uvicorn --reload) ===' && cd '${REPO_ROOT}/services' && MERIDIAN_OO_EXPORT=1 .venv/bin/uvicorn agents.server:app --reload --reload-dir '${REPO_ROOT}/services/agents' --host 127.0.0.1 --port 7823"
