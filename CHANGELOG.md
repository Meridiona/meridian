...
## [0.2.0](https://github.com/Meridiona/meridian/compare/v0.1.0...v0.2.0) (2026-06-01)


### ⚠ BREAKING CHANGES

* **meridian-agents:** replace vendored hermes with pip git dep
* **migrations:** services/meridian-agents/src/meridian_agents/db.py and its tests still reference summary_json/activity_kind on app_sessions — they will fail until updated in a follow-up commit. Intentional: this migration step lands in isolation per the agreed sequencing.
* **meridian-agents:** replace vendored hermes with pip git dep
* **migrations:** services/meridian-agents/src/meridian_agents/db.py and its tests still reference summary_json/activity_kind on app_sessions — they will fail until updated in a follow-up commit. Intentional: this migration step lands in isolation per the agreed sequencing.
...
* add PM update workflow and session summaries ([03ad78e](https://github.com/Meridiona/meridian/commit/03ad78ea80d5a3548436f70c9995aa0dfee5d26f))
...
* **agents:** implement dynamic LLM selection and download logic base… ([3a6b45c](https://github.com/Meridiona/meridian/commit/3a6b45c051410d7a1586f0deb4175f2118372fb9))
...
* **coding-agent:** port indexer + summariser into the Rust daemon ([7399401](https://github.com/Meridiona/meridian/commit/73994013c813375a8e1ee73c810c0d77526977f2))
...
* **eval:** dynamic LLM selector — /info endpoint + auto-discovery + --model flag ([0f2b87c](https://github.com/Meridiona/meridian/commit/0f2b87c5e17cb25a85cca8a7a03d3a3e9b959d36))
...
* **evals:** classifier experimentation harness + openobserve stability fixes ([ee3ccb0](https://github.com/Meridiona/meridian/commit/ee3ccb058b2214a5de9eb6a709894eaefebc9674))
* **evals:** Dev B sessions 16-20 — PROJ-201 completion and PROJ-225 profiling ([f50e600](https://github.com/Meridiona/meridian/commit/f50e600407c6992a7039412c387980f40aaa6210))
* **evals:** Dev B sessions 21-25 — hard discrimination cases and PROJ-230 ([9163e5d](https://github.com/Meridiona/meridian/commit/9163e5d59064ccd8e3974868fdd63ed4df91a001))
* **evals:** Dev B sessions 26-30 — bug fix, scope control, and PROJ-242 deference ([7eee871](https://github.com/Meridiona/meridian/commit/7eee87127c1cd3190ef5349a6a2e9f801bbb1d6e))
...
* **intelligence:** dynamic local LLM selection for task classifier (Apple Silicon) ([ead948e](https://github.com/Meridiona/meridian/commit/ead948eb824618cee4e2c1d56770f49b91a92877))
...
* **KAN-108:** Jira update agent — slot-based progress comments from Meridian activity ([0653351](https://github.com/Meridiona/meridian/commit/06533519b964ffd4e16c6499e56d64f1d64307d2))
...
* **logs:** split errors into a separate command (daemon + MLX) + docs ([ce82858](https://github.com/Meridiona/meridian/commit/ce8285838a45d4e9c874bf2eeece95c5c6fbf67a))
...
* **meridian-agents:** event-driven tagger via long-running daemon ([c8a8f68](https://github.com/Meridiona/meridian/commit/c8a8f68197b81abf822b045e58e03b0a2e897e90))
* **meridian-agents:** event-driven tagger via long-running daemon ([210201b](https://github.com/Meridiona/meridian/commit/210201b0f5e2bea98dd1ff722cc7ab2d1eb0006e))
...
* **meridian-agents:** replace vendored hermes with pip git dep ([baf3b73](https://github.com/Meridiona/meridian/commit/baf3b73eaba3f13682eb66f0a0474c69214198f1))
* **meridian-agents:** replace vendored hermes with pip git dep ([9cb835e](https://github.com/Meridiona/meridian/commit/9cb835ef72a7fe97b5272ecf43de01a77c9efd08))
...
* **meridian-agents:** tagger Stage-2 multi-sample max-pooling ([4ac67da](https://github.com/Meridiona/meridian/commit/4ac67da821e75ab5c3e2f37fb3a2c12d09af3eb6))
* **meridian-agents:** tagger Stage-2 multi-sample max-pooling ([e11cb63](https://github.com/Meridiona/meridian/commit/e11cb63599e0a6a88cca858086739e3a35ef67b9))
...
* **migrations:** rename 004→005 and rework agent schema ([c390a91](https://github.com/Meridiona/meridian/commit/c390a91cc5fe01d06847e81e521d493c9bc70380))
* **migrations:** rename 004→005 and rework agent schema ([a405be6](https://github.com/Meridiona/meridian/commit/a405be67c99b985c4a836a2ace3857b1b0c0dff9))
...
* **observability:** add comprehensive tracing to the pipeline ([88dda02](https://github.com/Meridiona/meridian/commit/88dda02a157b6b6bb73885af9b01de40b98fd9f8))
...
* one-command prebuilt install + semantic-versioned release pipeline (Model B) ([44cb57d](https://github.com/Meridiona/meridian/commit/44cb57d7a109af869bf1741647e2297946d8e791))
* persistent MLX server + OTel observability + one-command install + golden eval dataset ([a094007](https://github.com/Meridiona/meridian/commit/a0940073cbe69dcefbe2a9cff6d2a2427fb39923))
* **pm-worklog:** 'meridian worklog-status' — monitor worklogs without SQL ([517b376](https://github.com/Meridiona/meridian/commit/517b376b2513e5d19f61521e673334948161ffff))
...
* **pm-worklog:** in-daemon Stage 4 Jira worklog pipeline + global LLM gate ([fd94cb6](https://github.com/Meridiona/meridian/commit/fd94cb6070e3b4cf937718b93cfc40b061b1b46e))
...
* replace ax sidecar with coding agent indexer ([5b778e9](https://github.com/Meridiona/meridian/commit/5b778e9982b9123cf37bfb93c94620c9e2926fee))
...
* **server:** improve OpenTelemetry context handling in session classification ([c1ed6ef](https://github.com/Meridiona/meridian/commit/c1ed6ef3648f9e7b016686c8a767a13420def9e5))
...
* **ui:** show coding-agent time in the totals strip ([2f4c842](https://github.com/Meridiona/meridian/commit/2f4c842b9b5f713c4acf625c2f2bb3a8fe273c21))
...
* **ui:** Today's Tickets tile on the dashboard ([2c8afa4](https://github.com/Meridiona/meridian/commit/2c8afa41fc85e2e0d1c4c057f8ab84f58e80de65))
* **ui:** Today's Tickets tile on the dashboard ([e1926fb](https://github.com/Meridiona/meridian/commit/e1926fb3f4f82c3cda59058f4b2676c70e9db7c8))
...
* **agents:** validate MERIDIAN_DB env var at config load to prevent p… ([6be4590](https://github.com/Meridiona/meridian/commit/6be45905e6d8f7c709b823de71a6161788f86250))
...
* **ax-sidecar:** use OS process tree for host app detection + scan subagents/ ([3102568](https://github.com/Meridiona/meridian/commit/310256834222b65603f0133e734101097ce6a1cd))
...
* **classifier:** stop outlines truncating task reasoning at 300 chars ([500f590](https://github.com/Meridiona/meridian/commit/500f590e5fe1d458352556d246c99763fe3fa483))
...
* **daemon:** update MLX server launch script for direct Python execution ([c1ed6ef](https://github.com/Meridiona/meridian/commit/c1ed6ef3648f9e7b016686c8a767a13420def9e5))
...
* **evals:** correct model label phi-4-4bit → Qwen3.5-9B-OptiQ-4bit + TODO for /info endpoint ([925b1e8](https://github.com/Meridiona/meridian/commit/925b1e896305208efc1ae8ed20bbcd78cffa300e))
...
* **install:** MLX installer aborted when MERIDIAN_OO_AUTH unset ([0745032](https://github.com/Meridiona/meridian/commit/0745032c082288b38b428d2e74e956f97bcae2da))
* **install:** pin screenpipe to 0.3.350 via npm ([4df9df9](https://github.com/Meridiona/meridian/commit/4df9df9e2658afdbde614bd29af7e02b7ee32d2b))
...
* **install:** prompt for OO email+password separately on first install ([3fc3f9c](https://github.com/Meridiona/meridian/commit/3fc3f9cc341271c3850f612d6013c9aa0af37653))
...
* **install:** run pip install -e . so agents package is importable after setup ([54a7e0f](https://github.com/Meridiona/meridian/commit/54a7e0fa6d4100fd63ed9739a3d40736ed8fa885))
...
* **observability:** daemon logs to stdout so 'meridian logs' works ([73cce89](https://github.com/Meridiona/meridian/commit/73cce89fa949b66a64974173aecd0ab42d36aa75))
...
* **scripts:** chain coding-agent-indexer daemon and Claude hook into install scripts ([2a5bf80](https://github.com/Meridiona/meridian/commit/2a5bf8000326718bbf69c03faff61fe98441b6cb))
...
* **task-linker:** resolve post-merge protocol mismatch and import errors ([f319a98](https://github.com/Meridiona/meridian/commit/f319a988f3fc549753504d25d634586eb2ad4edf))
...
* **ui:** restore page.tsx after bad merge, remove stale field refs, add UI build to CI ([d60cf2b](https://github.com/Meridiona/meridian/commit/d60cf2b8f7d4b73511c917a533599a668b7d9a65))
...
* **ui:** update route types import path in next-env.d.ts ([0a24667](https://github.com/Meridiona/meridian/commit/0a24667f7b1ebb4d5c6673dcb0f0f0c535ea4148))
...
* **etl:** deduplicate session data at SQL level to reduce LLM noise ([b7d5039](https://github.com/Meridiona/meridian/commit/b7d5039ad5b60bb50321f3bc0723da781bdb275e))
