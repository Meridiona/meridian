...
* **oauth:** persist client_secret in jira.json so daemon can refresh tokens ([47aa3b3](https://github.com/Meridiona/meridian/commit/47aa3b3185a8a6665d81881cad0b18b7567b3805))
* **obs:** demote per-payload telemetry spool logs to TRACE ([6209b2e](https://github.com/Meridiona/meridian/commit/6209b2e88ffb41a6d450247e8b508d3201e369de)), closes [hi#frequency](https://github.com/hi/issues/frequency)
