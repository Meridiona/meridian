...
//
// Renders an hour's activity-report markdown (the activity-report LLM output —
// see assets/prompts/activity-report.md: ### section headings, **bold**
// topic/decision names, `-` bullets, plain paragraphs).
...
export function ActivityReport({ report, compact = false }: { report: string; compact?: boolean }) {
  ...
  const components: Components = {
    ...
    // The prompt (assets/prompts/activity-report.md) only ever emits
