/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6a41e3f36c13b201061c438f4c29532f)
// Runtime types generated with workerd@1.20260828.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	OTP_KV: KVNamespace;
	ENVIRONMENT: "staging" | "production";
	FROM_ADDRESS: "otp@auth.meridiona.com";
	FROM_NAME: "Meridian (staging)" | "Meridian";
	OTP_TTL_S: 600;
	MAX_VERIFY_ATTEMPTS: 5;
	RL_EMAIL_PER_DAY: 3;
	RL_IP_PER_HOUR: 30 | 10;
	RL_GLOBAL_PER_DAY: 500 | 2000;
	ALERT_THRESHOLD_PCT: 80;
	ALERT_EMAIL: "akarsh@meridiona.com";
	NOTIFY_EMAIL: "akarsh@meridiona.com" | "adithya@meridiona.com";
	NOTIFY_FROM: "Meridian Sign-ins (staging) <notify@meridiona.com>" | "Meridian Sign-ins <notify@meridiona.com>";
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ALERT_THRESHOLD_PCT: 80;
		ALERT_EMAIL: "akarsh@meridiona.com";
		NOTIFY_EMAIL: "akarsh@meridiona.com";
		NOTIFY_FROM: "Meridian Sign-ins (staging) <notify@meridiona.com>";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "FROM_ADDRESS" | "FROM_NAME" | "OTP_TTL_S" | "MAX_VERIFY_ATTEMPTS" | "RL_EMAIL_PER_DAY" | "RL_IP_PER_HOUR" | "RL_GLOBAL_PER_DAY" | "ALERT_THRESHOLD_PCT" | "ALERT_EMAIL" | "NOTIFY_EMAIL" | "NOTIFY_FROM">> {}
}
